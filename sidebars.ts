          ...
          items: [
            {
              ...
              items: [
                ...
                'academic-math/elementary/combinatorics',
          ...
          items: [
              ...
              items: [
                {
                  ...
                  items: [
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/real-numbers-and-functions',
                      label: '第一章 实数集与函数',
                    },
                    { type: 'doc', id: 'academic-math/analysis/limits', label: '第二章 数列极限' },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/function-limits',
                      label: '第三章 函数极限',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/continuity',
                      label: '第四章 函数的连续性',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/derivatives',
                      label: '第五章 导数与微分',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/mean-value-theorems',
                      label: '第六章 微分中值定理及其应用',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/taylor-expansion',
                      label: '（补）泰勒展开：局部信息的极限延伸',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/convexity-and-extremum',
                      label: '（续）凸函数、不等式与极值',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/completeness',
                      label: '第七章 实数的完备性',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/indefinite-integrals',
                      label: '第八章 不定积分',
                    },
                    { type: 'doc', id: 'academic-math/analysis/integrals', label: '第九章 定积分' },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/definite-integral-applications',
                      label: '第十章 定积分的应用',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/improper-integrals',
                      label: '第十一章 反常积分',
                    },
                  ],
                },
                {
                  ...
                  items: [
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/series',
                      label: '第十二章 数项级数',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/function-sequences',
                      label: '第十三章 函数列与函数项级数',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/power-series',
                      label: '第十四章 幂级数',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/fourier-series',
                      label: '第十五章 傅里叶级数',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/multivariable-limits',
                      label: '第十六章 多元函数的极限与连续',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/multivariable-differentiation',
                      label: '第十七章 多元函数微分学',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/differential-geometry',
                      label: '微分几何：曲线与曲面的局部理论',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/implicit-function-theorem',
                      label: '第十八章 隐函数定理及其应用',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/parametric-integrals',
                      label: '第十九章 含参量积分',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/multiple-integrals',
                      label: '第二十章 重积分',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/line-integrals',
                      label: '第二十一章 曲线积分',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/surface-integrals',
                      label: '第二十二章 曲面积分',
                    },
                    {
                      type: 'doc',
                      id: 'academic-math/analysis/vector-analysis',
                      label: '第二十三章 矢量分析与场论初步',
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              items: [
                {
                  type: 'doc',
                  id: 'academic-math/complex-analysis/index',
                  label: '1. 导论与解析性',
                },
                {
                  type: 'doc',
                  id: 'academic-math/complex-analysis/holomorphic-functions',
                  label: '2. 全纯性质与积分',
                },
                {
                  type: 'doc',
                  id: 'academic-math/complex-analysis/series-expansions',
                  label: '3. 级数展开与奇点',
                },
                {
                  type: 'doc',
                  id: 'academic-math/complex-analysis/residue-theory',
                  label: '4. 留数理论与应用',
                },
                {
                  type: 'doc',
                  id: 'academic-math/complex-analysis/conformal-mapping',
                  label: '5. 共形映射',
                },
              ],
            },
            ...
            },
            {
              ...
              items: [
                ...
                'academic-math/algebra/vector-spaces-and-linear-transformations',
                'academic-math/algebra/eigenvalues-and-jordan-form',
                'academic-math/algebra/singular-value-decomposition',
                'academic-math/algebra/inner-product-spaces',
                'academic-math/algebra/cayley-hamilton-and-rational-canonical-form',
                'academic-math/algebra/bilinear-forms',
                'academic-math/algebra/matrix',
                'academic-math/algebra/quadratic-forms',
                'academic-math/algebra/tensor-product',
              ],
            },
            { type: 'doc', id: 'math/number-theory', label: '数论基础与进阶' },
            { type: 'doc', id: 'math/combinatorics-and-game-theory', label: '组合计数与博弈论' },
            {
              type: 'doc',
              id: 'math/probability-and-randomized-algorithms',
              label: '概率期望与随机化算法',
            },
            {
              type: 'category',
              ...
              items: [
                ...
                'academic-math/abstract-algebra/group-actions-and-sylow',
                'academic-math/abstract-algebra/rings',
                'academic-math/abstract-algebra/modules-and-field-extensions',
            ...
            },
            {
              ...
              items: [
                ...
                'academic-math/discrete-math/relations-and-functions',
                'academic-math/discrete-math/relation-closures-and-warshall',
                'academic-math/discrete-math/algebraic-systems',
                'academic-math/discrete-math/lattice-theory',
                'academic-math/discrete-math/boolean-algebra-and-logic-circuits',
                'academic-math/discrete-math/graph-theory',
                'academic-math/discrete-math/combinatorics',
                'academic-math/discrete-math/recurrence-and-generating-functions',
              ],
            },
            {
              type: 'category',
  ...
  aiSidebar: [
    {
      ...
      items: [
        { type: 'doc', id: 'ai/ai-essentials', label: '人工智能精要：从机器学习、深度学习到大模型架构与自然语言处理' },
      ...
      items: [
        {
          ...
          items: ['cs/linux/basic-commands', 'cs/linux/permissions', 'cs/linux/file-system'],
        },
        {
          type: 'category',
          collapsible: true,
          ...
          items: ['cs/cpp/oop-basics', 'cs/cpp/modern-cpp'],
        },
  ...
  csExerciseSidebar: [
    {
      ...
      items: [
        ...
        { type: 'doc', id: 'exercises/cs/algorithm-geometry', label: '计算几何专项强化' },
