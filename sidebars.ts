...
const sidebars: SidebarsConfig = {
  ...
  algoSidebar: [
    ...
    },
    {
      ...
      items: ['graph/representation', 'graph/traversal', 'graph/shortest-path', 'graph/mst', 'graph/topo-sort', 'graph/tarjan', 'graph/sat', 'graph/network-flow', 'graph/bipartite-matching'],
    },
    {
      type: 'category',
      collapsible: true,
