...
export const graphData: GraphData = {
  nodes: [
    // Domains
    { id: 'math', name: '数学体系', val: 10, group: 1, type: 'domain', path: '/docs/academic-math/algebra' },
    ...
    // Math Categories
    { id: 'analysis', name: '数学分析', val: 7, group: 1, type: 'category', path: '/docs/academic-math/analysis' },
    { id: 'algebra', name: '高等代数', val: 7, group: 1, type: 'category', path: '/docs/academic-math/algebra' },
    { id: 'discrete', name: '离散数学', val: 7, group: 1, type: 'category', path: '/docs/academic-math/discrete-math' },
    { id: 'probability', name: '概率论', val: 7, group: 1, type: 'category', path: '/docs/academic-math/probability' },
    ...
    { id: 'number-theory', name: '数论', val: 5, group: 1, type: 'doc', path: '/docs/math/number-theory' },
    { id: 'matrix-pow', name: '矩阵快速幂', val: 5, group: 2, type: 'doc', path: '/docs/math/matrix-fast-pow' },
    { id: 'shortest-path', name: '最短路', val: 5, group: 2, type: 'doc', path: '/docs/graph/shortest-path' },
    { id: 'mst', name: '最小生成树', val: 5, group: 2, type: 'doc', path: '/docs/graph/mst' },
    { id: 'combinatorics', name: '组合数学', val: 5, group: 1, type: 'doc', path: '/docs/math/combinatorics' },
    { id: 'graph-theory-math', name: '图论(数学)', val: 5, group: 1, type: 'doc', path: '/docs/academic-math/discrete-math/graph-theory' },
    { id: 'logic', name: '数理逻辑', val: 5, group: 1, type: 'doc', path: '/docs/academic-math/discrete-math/logic' },
    { id: 'matrix-math', name: '矩阵论', val: 5, group: 1, type: 'doc', path: '/docs/academic-math/algebra/matrix' },
