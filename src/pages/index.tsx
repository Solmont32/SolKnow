      ...
      <div className="container">
        <motion.div initial="initial" animate="animate" variants={staggerContainer}>
          ...
          <motion.p variants={fadeInUp} className={styles.heroSubtitle}>
            计算机与数学交叉领域的 <b>集成式零基础学习系统</b>。<br />
            致力于极致的现代审美与工业级规范，构建从零开始的硬核知识大厦。
          </motion.p>
...
const FeatureList = [
  {
    ...
    Icon: Code2,
    description:
      '涵盖基础算法、数据结构、图论、动态规划等核心考点，包含详细的 C++ 代码模板与原理解析。',
    link: '/docs/intro',
    linkText: '查阅算法笔记',
    color: '#3b82f6',
  },
  ...
  },
  {
    ...
    Icon: Monitor,
    description:
      '从 Linux 操作系统、计算机网络到 C/C++ 与 Python 语言特性，构建完整的底层思维体系。',
    link: '/docs/cs/',
    linkText: '深入底层原理',
    color: '#f59e0b',
  },
  ...
  },
  {
    ...
    Icon: Youtube,
    description:
      '觉得文字难以理解？每篇核心笔记均支持嵌入 B 站视频讲解，实现图文与视听的双重输入。',
    link: '/videos',
    linkText: '观看视频课程',
    color: '#ef4444',
  },
...
export default function Home(): React.ReactNode {
  return (
    <Layout title={`首页`} description="计算机与数学交叉领域的集成式零基础学习系统">
      <HomepageHeader />
      <main>
        <Features />
      </main>
