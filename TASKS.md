...
## 总任务
- 数学知识库抽象代数教程（对标教科书）：知识点详细，一个知识点对应多道例题，同时增加练习库中的练习，练习需要有多道，答案折叠，点击才显示过程和答案；

## 待办子任务
- （暂无，已清空）

## 已完成任务
- [x] 打通『高等代数首页-练习库』导航闭环 (2026-03-08)：更新 docs/academic-math/algebra/index.md，新增高等代数练习库直达入口，形成章节-练习闭环。 (2026-03-08)
