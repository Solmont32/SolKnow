...
- **[第二十章 曲线积分](vector-calculus)**：第一/二型曲线积分、Green 公式。
- **[第二十一章 重积分](multiple-integrals)**：二重/三重积分、变量替换、Jacobi 行列式。
- **[第二十二章 曲面积分](vector-calculus)**：第一/二型曲面积分、Gauss 公式、Stokes 公式。
