...
### 1. 最优子结构验证 (Optimal Substructure)

**定义**：一个问题的最优解包含其子问题的最优解。
**验证步骤**：
1. **假设**：假设我们已经做出了当前步骤的最优选择（贪心选择）。
2. **规约**：证明在做出该选择后，原问题缩减为一个相同结构的子问题。
3. **结合**：证明子问题的最优解与当前贪心选择结合后，构成了原问题的最优解。
   - *反证法*：若存在更好的原问题解，则必然存在更好的子问题解，这与子问题最优性矛盾。

### 2. 微扰法 / 交换论证 (Exchange Argument)
